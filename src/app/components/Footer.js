...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white text-center p-4 mt-8">
      <div>
        <Link href="/about" className="w-auto text-gray-50 px-2 hover:underline hover:text-gray-300">
          TABUai? Como Funciona?
        </Link>
      </div>
      <div className="w-auto mt-2">
        <span className="mx-2 text-sm md:text-base">Desenvolvido por Felizardo</span>
