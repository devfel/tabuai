...
const highlight_IDs = [257, 264, 266, 270, 287, 288, 297, 301, 303];
  ...
  return (
    <Link href={`/product/${game.id}`} passHref>
      <div className="relative flex flex-row sm:flex-col cursor-pointer bg-white rounded-lg border border-gray-200 shadow-md hover:shadow-md hover:shadow-gray-950 dark:bg-gray-800 dark:border-gray-700 w-full group">
        <div className="w-5/12 sm:w-full sm:flex sm:justify-center items-center overflow-hidden rounded-l-lg sm:rounded-t-lg sm:rounded-bl-none p-2 bg-gray-300 h-48 sm:h-44">
        ...
        <div className="p-4 w-7/12 sm:w-full" style={{ height: "185px" }}>
